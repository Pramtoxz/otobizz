...
.main-footer {
    background: linear-gradient(135deg, #4A2C85 0%, #6F42C1 50%, #9C7AE8 100%) !important;
...
<footer class="main-footer">
    <div class="footer-content">
        <div class="footer-info">
            <img src="<?= base_url() ?>assets/img/otobizz.png" alt="Logo" class="footer-logo">
        ...
        <div class="footer-version d-none d-sm-block">
            <b>Version</b> 1.0.0
