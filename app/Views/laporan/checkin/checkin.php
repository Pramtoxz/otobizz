...
<div class="col-md-12">
    <div class="card card-purple">
        <div class="card-header">
            <h3 class="card-title">Laporan Check In</h3>
            <!-- /.card-tools -->
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            ...
            <div class="row-sm-12" id="printHalaman">
                ...
                <div class="d-flex justify-content-center align-items-center text-center">
                    ...
                    <div>
                        ...
                        <b style="font-size: 20px; font-family: 'Times New Roman'; margin-bottom: 0; text-decoration: underline;">Laporan Check In</b>
                    </div>
                </div>
                <div class="tabelObat">
...
<script>
    function ViewLaporanTanggal() {
        ...
        if (tglmulai == '') {
            ...
            $.ajax({
                type: "POST",
                url: "<?= base_url('laporan-wisma/checkin/viewallcheckintanggal') ?>",
                data: {
                    tglmulai: tglmulai,
                    tglakhir: tglakhir,
                },
    ...
    function ViewLaporanPerbulan() {
        ...
        if (bulanawal == '') {
            ...
            $.ajax({
                type: "POST",
                url: "<?= base_url('laporan-wisma/checkin/viewallcheckinbulan') ?>",
                data: {
                    bulanawal: bulanawal,
