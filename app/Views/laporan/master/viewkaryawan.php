...
/* Column styles for karyawan specific fields */
...
<?php if (empty($karyawan)): ?>
    <div class="empty-state">
        ...
        <p class="text-muted">Belum ada data karyawan yang terdaftar dalam sistem.</p>
    </div>
<?php else: ?>
    <div class="modern-table-container">
        <table class="modern-table">
            <thead>
                <tr>
                    ...
                    <th style="width: 200px; text-align: left;">Nama Karyawan</th>
        ...
        <div class="table-stats">
            <div class="stats-item">
                <i class="fas fa-user-friends"></i>
                <span><strong>Total Karyawan:</strong> <?= count($karyawan) ?> orang</span>
            </div>
            <div class="stats-item">
