        ...
        <div class="card-body modern-card-body">
                    ...
                    <div class="col-md-6">
                        <div class="d-flex flex-wrap align-items-center">
                            <button class="btn btn-modern btn-view" onclick="ViewLaporanSemua()" 
                                    title="Memuat dan menampilkan data karyawan terbaru (Ctrl+R)">
            ...
            <div class="report-container" id="printHalaman">
                <div class="print-header">
                    ...
                    <div class="print-title">Laporan Data Karyawan</div>
                </div>
...
<script>
        ...
        $container.html(`
            <div class="loading-container">
                <div style="text-align: center; color: #6F42C1;">
                    ...
                    <h5>Selamat Datang di Laporan Karyawan</h5>
                    <p class="text-muted">Klik tombol "Tampilkan Laporan" untuk memuat data karyawan terbaru</p>
                </div>
            </div>
        `);
    }
    ...
    function ViewLaporanSemua() {
        ...
        $.ajax({
            type: "GET",
            url: "<?= base_url('laporan-master/karyawan/view') ?>",
            dataType: "JSON",
            ...
            success: function(response) {
                ...
                if (response.data) {
                    ...
                    showNotification('success', 'Data Berhasil Dimuat', 'Data karyawan telah berhasil ditampilkan');
                } else {
                    // Handle empty data
                    $container.html(`
                        <div class="empty-state">
                            ...
                            <p class="text-muted">Belum ada data karyawan yang tersedia</p>
                        </div>
                    `);
                    showNotification('info', 'Data Kosong', 'Belum ada data karyawan yang tersedia');
                }
            },
        ...
        setTimeout(function() {
            try {
                ...
                printWindow.document.write(`
                    ...
                    <html>
                    <head>
                        <title>Laporan Karyawan - Oto Bizz</title>
                        <style>
                            body { 
                                font-family: 'Times New Roman', serif; 
                                margin: 20px; 
