...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card card-purple">
            ...
            <div class="card-body">
                <?= form_open('pelanggan/save', ['id' => 'formtambahpelanggan', 'enctype' => 'multipart/form-data']) ?>
                <?= csrf_field() ?>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input type="text" id="idpelanggan" name="idpelanggan" class="form-control" value="<?= $auto_number ?>" readonly>
