    ...
    <div class="col-md-12">
        <div class="card card-info">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" id="idcheckout" name="idcheckout" class="form-control" value="<?= $checkout['idcheckout'] ?>" readonly>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="hidden" id="idcheckin" name="idcheckin" class="form-control" value="<?= $checkout['idcheckin'] ?>" readonly>
                                <input type="text" id="kode_checkin" name="kode_checkin" class="form-control" value="<?= $checkout['idcheckin'] ?>" readonly>
                                <div class="input-group-append">
                                    <button class="btn btn-info" type="button" id="btnModalCariCheckin" data-toggle="modal" data-target="#modalcariCheckin">Ganti</button>
                                </div>
                ...
                <div class="row" id="detailCheckin">
                    <div class="col-md-8">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                <tr>
                                                    ...
                                                    <td id="display_nama_tamu"><?= $checkout['nama_tamu'] ?></td>
                                                </tr>
                                                <tr>
                                                    <th>NIK</th>
                                                    <td id="display_nik"><?= $checkout['nik'] ?></td>
                                                </tr>
                                                <tr>
                                                    <th>No HP</th>
                                                    <td id="display_nohp"><?= $checkout['nohp'] ?></td>
                                                </tr>
                                                <tr>
                                                    <th>Nama Kamar</th>
                                                    <td id="display_nama_kamar"><?= $checkout['nama_kamar'] ?></td>
                                                </tr>
                                                <tr>
                                                    <th>Harga Per Malam</th>
                                                    <td id="display_harga_kamar">Rp <?= number_format($checkout['harga_kamar'], 0, ',', '.') ?></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                <tr>
                                                    ...
                                                    <td id="display_tglcheckin"><?= date('d-m-Y', strtotime($checkout['tglcheckin'])) ?></td>
                                                </tr>
                                                <tr>
                                                    <th>Tanggal Checkout</th>
                                                    <td id="display_tglcheckout"><?= date('d-m-Y', strtotime($checkout['tglcheckout'])) ?></td>
                                                </tr>
                                                <tr>
                                                    <th>Lama Menginap</th>
                                                    <td id="display_lama_hari"><?= $checkout['lama_hari'] ?> hari</td>
                                                </tr>
                                                <tr>
                                                    <th>Total Bayar</th>
                                                    <td id="display_totalbayar">Rp <?= number_format($checkout['totalbayar'], 0, ',', '.') ?></td>
                                                </tr>
                                                <tr>
                                                    <th>Sisa Bayar</th>
                                                    <td id="display_sisabayar">Rp <?= number_format($checkin['sisabayar'], 0, ',', '.') ?></td>
                                                </tr>
                                                <tr>
                                                    <th>Deposit</th>
                                                    <td id="display_deposit">Rp <?= number_format($checkin['deposit'], 0, ',', '.') ?></td>
                                                </tr>
                                                <tr style="background-color: #f8f9fa;">
                                                    <th style="color: #28a745;">Kembalian</th>
                                                    <td id="display_grandtotal" style="font-weight: bold; color: #28a745;">Rp <?= number_format($checkout['grandtotal'], 0, ',', '.') ?></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
                ...
                <!-- Form Input Checkout -->
                <div class="row" id="formInputCheckout">
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" id="tglcheckin" name="tglcheckin" class="form-control" value="<?= date('Y-m-d', strtotime($checkout['tglcheckin'])) ?>" readonly>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" id="tglcheckout_actual" name="tglcheckout_actual" class="form-control" value="<?= date('Y-m-d', strtotime($checkout['tglcheckout'])) ?>">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea id="keterangan" name="keterangan" class="form-control" rows="3" placeholder="Keterangan checkout (opsional)"><?= $checkout['keterangan'] ?></textarea>
                        </div>
                    </div>
                </div>
